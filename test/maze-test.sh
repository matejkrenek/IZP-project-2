...
test_example() {
    ...
    ../.build/main $execArgs 1> ./results/ex$exampleN-your_stdout.txt 2> ./results/ex$exampleN-your_stderr.txt
...
# test compilation
echo "  Compilation: gcc -std=c11 -Wall -Wextra -Werror main.c -o main"
gcc -std=c11 -Wall -Wextra -Werror ../src/main.c -o ../.build/main > ./results/compilation_out.txt 2>&1
ret=$?
if [ $ret -ne 0 ]; then
